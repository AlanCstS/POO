 ...
 * A01708668
 * 14/06/22
 * Este proyecto realiza la cuenta total similar a lo que sería en un 
 * restaurante común para poder añadir los consumibles específicos que
 * el usuario desee, para darle una cuenta total de todos estos
 * consumibles desglosados con sus respectivos precios, y el total de la cuenta
*/
