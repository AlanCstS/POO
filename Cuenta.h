...
/**
 * agraga_tacos es una función que se encarga de añadir al arreglo de consumibles (comida[]) un objeto de tipo taco
 * 
 * Por un ciclo for, crea un nuevo objeto de tipo Taco en el heap mediante el uso de la palabra reservada 'new'
 * para usar el polimorfismo y lo añade al siguiente número del arreglo dinámico ya guardado para poder
 * modificarlo 
 * @param  
 */
...
/**
 * agraga_bebidas es una función que se encarga de añadir al arreglo de consumibles (comida[]) un objeto de tipo bebida
 * 
 * Por un ciclo for, crea un nuevo objeto de tipo Bebidas en el heap mediante el uso de la palabra reservada 'new'
 * para usar el polimorfismo y lo añade al siguiente número del arreglo dinámico ya guardado para poder
 * modificarlo 
 * @param  
 */
