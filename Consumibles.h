 ...
 * A01708668
 * 14/06/22
 * Esta clase define el objeto tipo Consumibles que contiene las clases heredadas 
 * Tacos y Bebidas
*/
...
class Tacos:public Consumibles{
    ...
    Tacos(string ca, string t, int c){ tipo="taco";cantidad = c; carne = ca; tortilla = t;} 
...
class Bebidas:public Consumibles{
    ...
    Bebidas(string r, string a, int c){tipo = "bebida"; refresco = r; agua = a; cantidad = c;}
